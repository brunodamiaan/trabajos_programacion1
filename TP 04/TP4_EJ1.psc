...
Algoritmo TP4_EJ1
	...
	Definir i, arregloNumerosPares, cont, tamanio Como Entero
	
	// Inicializamos las variables
	cont=0
	tamanio=200
	
	Dimension arregloNumerosPares[100]
	
	// Ciclo para buscar y guardar los 100 primeros numeros pares 
	Para i=0 Hasta tamanio-1 Con Paso 1 Hacer
		Si(i%2==0) // Calculamos si su resto es 0 
			arregloNumerosPares[cont]=i // Asigno al arreglo el número par encontrado 
	...
	Para i=0 Hasta cont-1 Con Paso 1 Hacer
		Escribir , arregloNumerosPares[i]
		Escribir ""
	FinPara
